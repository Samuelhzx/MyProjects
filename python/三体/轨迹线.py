...
#    window.blit(star3,r3)
    pg.draw.line(window, ('blue'), (pp.real, pp.imag), (p1.real, p1.imag))
    pg.draw.line(window, ('green'), (ppp.real, ppp.imag), (p2.real, p2.imag))
    pg.draw.line(window, ('red'), (pppp.real, pppp.imag), (p3.real, p3.imag))
    timee += 1
    pg.display.flip()
